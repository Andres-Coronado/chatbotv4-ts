            ...
            if (didBotWelcomedUser === false) {
                ...
                switch (text) {
                    ...
                    case 'help':
                        ...
                        break;
                    case 'test':
                        await context.sendActivity(`hice puse un postBack y aqui puedo mandar mas cosas
                        mi nombre es Andres Coronado
                        `);
                        await this.sendIntroCard(context);
                        break;
                    case 'testdeimback':
                        await context.sendActivity(`hice puse un testdeimback y aqui puedo mandar mas cosas
                        mi nombre es Andres Coronado
                        `);
                        await this.sendIntroCard(context);
                        break;
