            ...
            if (didBotWelcomedUser === false) {
                ...
                switch (text) {
                    ...
                    case 'help':
                        ...
                        break;
                    case 'test':
                        yield context.sendActivity(`hice puse un postBack y aqui puedo mandar mas cosas
                        mi nombre es Andres Coronado
                        `);
                        break;
                    case 'testdeimback':
                        yield context.sendActivity(`hice puse un testdeimback y aqui puedo mandar mas cosas
                        mi nombre es Andres Coronado
                        `);
                        break;
                    default:
